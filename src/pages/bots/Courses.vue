<template>
  <main-layout>
    <el-row :gutter="20">
      ...
      <el-col :span="4">
        <el-input v-model="criteria.parentId" placeholder="请输入主题id" />
      </el-col>
      <el-col :span="2">
    ...
    <el-table :data="this.list" v-loading="loading">
      ...
      <el-table-column prop="content" label="课程名称">
        <template slot-scope="scope">
          <span>{{ scope.row.relaList[0].content }}</span>
        </template>
      </el-table-column>
      <el-table-column prop="parentId" label="所属主题id"> </el-table-column>
      ...
      <el-table-column prop="courses" label="新增卡片" width="80">
        <template slot-scope="scope">
          <el-button
            type="text"
            @click="handleToPage({ page: 'card', item: scope.row })"
            >添加</el-button
          >
        </template>
      </el-table-column>
    ...
    >
      <div class="box">
        <header>
          <h3 class="h3-tg">课程管理 / {{ editTitle }}</h3>
        </header>
        <el-tabs
        ...
        >
          ...
          >
            ...
            >
              ...
              <el-form-item label="主题id" prop="parentId">
  ...
  data: function() {
    return {
      ...
      validRules: {
        ...
        parentId: [{ required: true, message: "请选择主题" }],
      },
    };
  },
  created() {
